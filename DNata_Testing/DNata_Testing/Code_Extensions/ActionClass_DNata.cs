...
//using Clientapp_Tester.TestData;
...
namespace DNata.TestScenarios
{
     public static class ActionClass
    {
        ...
        public static IWebDriver InitializeDriver()
        {
            ...
            var _baseURL = Environment.GetEnvironmentVariable(Config.EnvironmentVARIABLE.PrimeKEY + "BASEURL");
            ...
            string Config_BaseURL = EnvironmentVariableVALIDATE(Config.EnvironmentVARIABLE.PrimeKEY, "BASEURL_DNata", Config.BaseURL_DNata);
          ...
          //  Environment.SetEnvironmentVariable(Config.EnvironmentVARIABLE.PrimeKEY + "USERNAME", "ian.campbell@rosslyndatatech.com");

            Config.BaseURL = EnvironmentVariableVALIDATE(Config.EnvironmentVARIABLE.PrimeKEY, "BASEURL", Config_BaseURL);
            Config.Credentials.TestUsername = EnvironmentVariableVALIDATE(Config.EnvironmentVARIABLE.PrimeKEY, "TESTUSERNAME", Environment.GetEnvironmentVariable(Config.EnvironmentVARIABLE.PrimeKEY + "TESTUSERNAME"));
            Config.Credentials.TestUserpassword = EnvironmentVariableVALIDATE(Config.EnvironmentVARIABLE.PrimeKEY, "TESTUSERPASSWORD", Environment.GetEnvironmentVariable(Config.EnvironmentVARIABLE.PrimeKEY + "TESTUSERPASSWORD"));
